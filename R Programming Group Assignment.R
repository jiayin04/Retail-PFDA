...
=======
# install.packages(c("tidyr", "data.table", "dplyr", "ggplot2", "janitor", "missForest", "VIM", "zoo", "gender", "stringr", "mice", "caret", "pROC", "RColorBrewer"))
>>>>>>> Stashed changes
...
View(retail_data)
=======
WD <- "C:/Users/leeai/OneDrive - Asia Pacific University/APU/Degree/SEM 1/Programming in Data Analysis/src" # Change to your WD
...
summary(retail_data)
=======
# get back cleaned data quick:
retail_data_proc = readRDS("cleaned_retail_data.rds")
