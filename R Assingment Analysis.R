# Analysis 1 : What are the behavioral & satisfaction patterns of diff cust demographic / Age only
...
#Analysis 2 : Predicting satisfaction w both demographic / Age only & purchasing behavior
...
#Analysis 3 : Customer profiling based on behavior, satisfaction & demographic / Age only
...
########################################
# Cust profilling using age and ratings
...
#Analysis 4 : Wwhat strategies can improve satisfaction in low rated but high value customer (demographic / age only)
...
# this one dont hv much difference between each other
